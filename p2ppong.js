// ===================================================================
// P2PPong vFinal — Всё работает. Первое касание, Ratchet, WebRTC.
// ===================================================================
...
const P2PPong = {
    ...
    async _saveCh() { var arr = []; var me = this; Object.keys(this._channels).forEach(function(id) { var ch = me._channels[id]; arr.push({ id: id, peerId: ch.peerId, type: ch.type, expires: ch.expires, createdAt: ch.createdAt }); }); try { localStorage.setItem('p2ppong_channels', JSON.stringify(arr)); } catch(e) {} },
