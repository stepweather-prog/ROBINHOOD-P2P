...
function handleIncomingMessage(data) {
    ...
    if (data.voiceData) {
        ...
        const avatar = data.avatar || ct?.avatar || 'icons/01icon.png';
    ...
    try {
        ...
        if (parsed.voice) {
            ...
            const avatar = ct?.avatar || 'icons/01icon.png';
            if (data.channelId === activeChannelId) {
