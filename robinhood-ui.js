...
function initUI() {
    ...
    P2PPong.on('message-received', (data) => { console.log('ВСЕ ДАННЫЕ СООБЩЕНИЯ:', JSON.stringify({ nick: data.nick, avatar: data.avatar, text: data.text?.substring(0, 30), voiceData: !!data.voiceData })); handleIncomingMessage(data); });
