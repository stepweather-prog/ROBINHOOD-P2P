...
function playQuiverAnimation() {
    ...
    img.onerror = () => { wrapper.textContent = '✓'; };
...
async function sendWebRTCMsg(type, sdp) { if (!activeChannelId) return; P2PPong._post('/beacon', { keyHash: 'webrtc_' + activeChannelId, packet: JSON.stringify({ type: type, sdp: sdp, peerId: P2PPong._peerId }) }); }
