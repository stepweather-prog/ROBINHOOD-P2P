...
function saveStats(){try{var stats={version:PEER_HELP_VERSION,totalUploaded:totalUploaded,totalDownloaded:totalDownloaded,peersCount:knownPeers.size,lastSaved:Date.now()};localStorage.setItem('robinhood_peer_help_stats',JSON.stringify(stats))}catch(e){}}

function loadStats(){try{var raw=localStorage.getItem('robinhood_peer_help_stats');if(raw){var stats=JSON.parse(raw);totalUploaded=stats.totalUploaded||0;totalDownloaded=stats.totalDownloaded||0}}catch(e){}}
